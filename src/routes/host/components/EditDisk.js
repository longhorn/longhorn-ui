...
const modal = ({
  ...
  function handleOk() {
    validateFields((errors) => {
      ...
      Object.assign(selectedDisk, data)
      onOk(selectedDisk)
    })
  }
  ...
  Object.assign(disk, selectedDisk)
        ...
        <div className={styles.formItem} style={{ width: '109%' }}>
          <div className={styles.control}>
            ...
            <FormItem style={{ margin: 0 }}>
              <Input disabled={true} value={disk.nodeID} />
            </FormItem>
          </div>
          <div className={styles.control}>
            <div className={styles.label}>
            ...
            <FormItem style={{ margin: 0 }}>
              <Input disabled={true} value={disk.name} />
            </FormItem>
          </div>
          <div className={styles.control}>
            <div className={styles.label}>
            ...
            <FormItem style={{ margin: 0 }}>
              <Input disabled={true} value={disk.path} />
            </FormItem>
          </div>
        </div>
