...
import { Form, Input, Checkbox, Icon, InputNumber, Tooltip } from 'antd'
  ...
  return (
    <ModalBlur {...modalOpts}>
      <Form layout="horizontal">
        ...
        <FormItem label="Read only" {...formItemLayout}>
          {getFieldDecorator('readOnly', {
            valuePropName: 'checked',
            initialValue: item.readOnly,
          })(<Checkbox />)}
        </FormItem>
        <FormItem label="Set as default" {...formItemLayout}>
